programa {
  funcao inicio() {
    ...
    imprimirZeresima(nome1, nome2, nome3, num1, num2, num3, votos1, votos2, votos3)
  ...
  funcao vazio imprimirZeresima(cadeia nome1, cadeia nome2, cadeia nome3,
          inteiro num1, inteiro num2, inteiro num3,
          inteiro votos1, inteiro votos2, inteiro votos3){
